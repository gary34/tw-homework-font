...
#app {
    ...
    height: 200px;
    color: #fff;
    background: url(https://iyomi-public.oss-cn-shenzhen.aliyuncs.com/full_width_image_desktop-03801d8bdff4556807329690ead6287f.png) no-repeat center center #295448;
    text-align: center;
}
